...
h.comparedTo = h.cmp = function (e) {
	var n,
		...
		f = e.s;
	if (!o || !u)
		return !c || !f ? Number.NaN : c !== f ? c : o === u ? 0 : !o ^ (c < 0) ? 1 : -1;
...
h.minus = h.sub = function (e) {
	...
	if (
		((f = this.d), (d = e.d), (u = v.precision), (c = v.rounding), !f[0] || !d[0])
	) {
		if (d[0]) e.s = -e.s;
...
h.plus = h.add = function (e) {
	...
	if (
		((f = this.d), (l = e.d), (u = d.precision), (c = d.rounding), !f[0] || !l[0])
	)
...
h.precision = h.sd = function (e) {
	...
	return (
		this.d ? ((n = $e(this.d)), e && this.e + 1 > n && (n = this.e + 1)) : (n = Number.NaN), n
	);
};
h.round = function () {
	var 
