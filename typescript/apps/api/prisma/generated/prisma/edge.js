...
const config = {
	generator: {
		...
		output: {
			value:
				"/Users/sakaguchiraku/dev/expo-nativewind-better-auth-prisma/typescript/apps/api/prisma/generated/prisma",
			fromEnvVar: null,
		},
		config: {
			engineType: "library",
		...
		previewFeatures: [],
		sourceFilePath:
			"/Users/sakaguchiraku/dev/expo-nativewind-better-auth-prisma/typescript/apps/api/prisma/schema.prisma",
		isCustomOutput: true,
	},
	relativeEnvPaths: {
		rootEnvPath: "../../../.env",
