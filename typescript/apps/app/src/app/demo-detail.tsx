        ...
        <View style={styles.content}>
          ...
          <View style={styles.section}>
            ...
            <Text style={[styles.description, { color: Colors.text }]}>
              This is a detailed demo page that you navigated to from the home screen.
              It demonstrates how Stack navigation works in this app.
            </Text>
          </View>
          ...
          <View style={styles.section}>
            ...
            <View style={styles.featureItem}>
              <Ionicons name="checkmark-circle" size={24} color={Colors.tint} />
              <Text style={[styles.featureText, { color: Colors.text }]}>Custom Header Styling</Text>
            </View>
            <View style={styles.featureItem}>
              <Ionicons name="checkmark-circle" size={24} color={Colors.tint} />
          ...
          <View style={styles.section}>
            ...
            <Text style={[styles.description, { color: Colors.text }]}>
              You can navigate back to the home screen using the back button in the header,
